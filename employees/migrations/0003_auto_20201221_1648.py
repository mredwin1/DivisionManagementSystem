...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('employees', '0002_auto_20201114_1403'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='employee',
            name='email_last_final',
            field=models.BooleanField(default=True, help_text='Receive an email when a last and final is issued', verbose_name='Last and Final'),
        ),
    ]
