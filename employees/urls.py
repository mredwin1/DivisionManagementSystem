...
urlpatterns = [
    ...
    path('account/<int:employee_id>/<str:download>/<int:notification_id>', employee_views.account, name='employee-account'),
    ...
    path('attendance-download/<int:employee_id>/<int:attendance_id>/', employee_views.download_attendance, name='employee-attendance-download'),
    path('attendance-download/<str:attendance_id_list>/', employee_views.download_attendance, name='employee-attendance-download'),
    ...
    path('counseling-download/<int:employee_id>/<int:counseling_id>/', employee_views.download_counseling, name='employee-counseling-download'),
    ...
    path('safety-point-download/<int:employee_id>/<int:safety_point_id>/', employee_views.download_safety_point, name='employee-safety-point-download'),
