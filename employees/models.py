...
class Employee(AbstractBaseUser, PermissionsMixin):
    ...
    class Meta:
        ...
        permissions = [
            ...
            ('can_export_safety_point_history', 'Can export safety history'),
...
class SafetyPoint(models.Model):
    REASON_CHOICES = [
        ...
        ('3', 'Improper following distance'),
        ('4', 'Conviction of a minor traffic violation'),
        ('5', 'Backing incident or collision'),
        ('6', 'Minor Preventable incident'),
        ...
        ('10', 'Any preventable roll-away incident or collision regardless of damage amount'),
        ('11', 'Failure to properly secure/transport a mobility device'),
